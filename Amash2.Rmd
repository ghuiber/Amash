...
I am proposing a non-parameteric test because, as you can see in the density plot above, donations from the security-industrial complex do not follow a normal distribution across US representatives. Non-parametric tests do not require distributional assumptions, with the added advantage for this exercise that they have somewhat lower power as a result. In other words, I may miss some differences in funding, so my exercise can't be accused of stacking the deck in favor of finding them.
